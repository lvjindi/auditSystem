...
from account.view.auditSys import UserLoginAPI, UserRegisterAPI, RoleAPI, LogoutAPI, DepartmentAPI
...
urlpatterns = [
    ...
    url(r"^department/?$", DepartmentAPI.as_view(), name="department_api"),
]
